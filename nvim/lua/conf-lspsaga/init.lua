...
local config = {
  ...
  finder_action_keys = {open = 'o', vsplit = 's', split = 'i', quit = '<Esc>', scroll_down = '<C-f>', scroll_up = '<C-b>'},
...
vim.api.nvim_set_keymap('n', '<leader>pr', [[<Cmd> lua require'lspsaga.provider'.lsp_finder()<CR>]], {silent = true, noremap = true})
...
vim.api.nvim_set_keymap('n', '<leader>to', [[<Cmd> lua require('lspsaga.floaterm').open_float_terminal()<CR>]], {silent = true, noremap = true})
vim.api.nvim_set_keymap('t', '<leader>tc', [[<Cmd> lua require('lspsaga.floaterm').close_float_terminal()<CR>]], {silent = true, noremap = true})
