...
function M.convert(name)
    ...
    local function color_insert(color)
        for k, v in pairs(colors) do if v == color then return nil end end
    ...
    local function get_color(color)
        for k, v in pairs(colors) do if v == color then return 'colors.' .. k end end
        colors['color' .. next_color] = color
        next_color = next_color + 1
        return color
    end
...
-- =============================================================================
    ...
    for k, v in pairs(colors) do file:write(string.format('  %-8s = "%s",\n', k, v)) end
    file:write('}\n\n')
